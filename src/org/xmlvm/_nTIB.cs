...
namespace org.xmlvm {
    ...
    public class _nTIB : global::java.lang.Object {
        ...
        public bool isArray() {
           // return myType.IsArray;
            // return myType.GetInterface("org.xmlvm._nIArray")!=null;
            return typeof(org.xmlvm._nIArray).GetTypeInfo().IsAssignableFrom(this.myType.GetTypeInfo());// sAssignableFrom(this.myType);
        }
        ...
        public bool isPrimitive() {
            return this.myType.GetTypeInfo().IsPrimitive;
        }
