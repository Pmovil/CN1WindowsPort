...
namespace WindowsPhone8Demo.Extensions
{
    public class AsyncPictureDecoderExtension : java.lang.Runnable
    {
        ...
        public void run()
        {
            result.scanCompleted(SilverlightImplementation.toJava(contents), SilverlightImplementation.toJava(format), new global::org.xmlvm._nArrayAdapter<sbyte>(raw));
        }
        ...
        private void AddBarcodeToResults(ZXing.Result result)
        {
            ...
            raw = SilverlightImplementation.toSByteArray(result.RawBytes);
